...
// copied from index.js of delta-e npm package
function DeltaE() {}

// rgb should be an array of 3 integers
DeltaE.prototype.getDeltaE00FromRGB = function(rgb1, rgb2) {
	lab1 = rgb2lab(rgb1);
	lab2 = rgb2lab(rgb2);
	return this.getDeltaE00(lab1, lab2);
}
